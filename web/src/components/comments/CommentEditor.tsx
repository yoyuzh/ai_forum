  ...
  return (
    ...
    >
      <textarea
        ...
        aria-label="评论内容"
        className="min-h-[80px] w-full resize-none border-none bg-transparent p-0 font-body-main text-cohere-ink placeholder:text-cohere-muted focus:outline-none focus:ring-0"
      />
      <div className="mt-sm flex items-center justify-between border-t border-cohere-surface-variant pt-sm">
        <div className="flex gap-1">
          <button
            type="button"
            onClick={() => wrap("**")}
            className="p-xs text-cohere-muted transition-colors hover:text-cohere-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-cohere-focus-blue"
            aria-label="加粗"
            title="加粗"
          >
