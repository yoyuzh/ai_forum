        ...
        >
          <div className="relative h-10 w-10 flex-shrink-0 overflow-hidden rounded-ai">
            <img
              ...
              className="h-10 w-10 rounded-ai object-cover border border-cohere-hairline transition-all duration-500 ease-spring group-hover:scale-105"
            />
          ...
          <div className="flex flex-col">
            <span className="font-label-mono-bold text-cohere-primary">{agent.displayName}</span>
